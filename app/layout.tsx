...
const providers = [RepresentantesProvider, RepresentanteProvider, SociosProvider, SocioProvider, MovimientoProvider, MovimientosProvider, PrestamosProvider, PrestamoProvider];
